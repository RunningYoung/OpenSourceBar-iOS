...
QuickSpecBegin(QuickTests)
    ...
    describe(@"Session", ^{
        ...
        sharedExamples(@"shared examples", ^(QCKDSLSharedExampleContext context) {
            NSNumber *sharedObject = context()[@"shareObject"];
            //shared it
        });

        itBehavesLike(@"shared examples", ^NSDictionary * {
